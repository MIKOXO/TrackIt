...
const steps = [
  {
    ...
    description: 'Start by logging your income and expenses.',
  },
  {
    icon: FiPieChart,
    eyebrow: 'Step 02',
      ...
      <div className='mx-auto grid max-w-6xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16 lg:px-8 lg:py-16'>
        <motion.div
          ...
          <p className='mt-4 max-w-lg text-sm leading-6 text-slate-600 dark:text-slate-300'>
            TrackIt is designed to move from raw activity to useful answers
            fast. You add data, the product surfaces patterns, and the AI helps
