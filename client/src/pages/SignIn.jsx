  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const finalDestination =
        response.data.user?.role !== 'admin' &&
        !response.data.user?.securityQuestionSet
          ? '/security-question'
          : destination;
      ...
      if (/suspend|delete/i.test(normalized)) {
        setSuspendedModal({
          open: true,
          message,
          heading: /delete/i.test(normalized)
            ? 'Account deleted'
            : 'Account suspended',
        });
      }
            ...
            <motion.div
              ...
              <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <motion.button
                  ...
                  whileHover={
                    isSignInReady && !showSignInLoading ? { y: -2 } : undefined
                  }
                  whileTap={
                    isSignInReady && !showSignInLoading
                      ? { scale: 0.98 }
                      : undefined
                  }
                  type='submit'
              ...
              <div className='space-y-6'>
                ...
                <motion.div
                  ...
                  <p className='text-sm text-slate-600 dark:text-slate-400'>
                    Check back soon for AI-powered budget recommendations and
                    spending alerts.
                  </p>
                </motion.div>
              </div>
